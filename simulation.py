...
for p in range(0, M):
    ...
    for r, q in enumerate(CylinderVolumeWithError, start=0):
        # Variance
        ...
        VarB1 += (BoxVolume[r * 5] - BoxVolumeWithError[r]) * (BoxVolume[r] - BoxVolumeWithError[r])
...
print("Number of simulation: " + M + "\n")
print("Variation in Cylinder with error: " + math.sqrt(VarC1 / (M * N / 5)) + "\n")
print("Variation in Cylinder Average of 5: " + math.sqrt(VarC5 / (M * N / 5)) + "\n")
print("Variation in Cylinder Average of 10: " + math.sqrt(VarC10 / (M * N / 10)) + "\n")
print("Variation in Cylinder Best 3 of 5: " + math.sqrt(VarC3 / (M * N / 5)) + "\n")
print("Variation in Cylinder Median of 5: " + math.sqrt(VarCM / (M * N / 5)) + "\n")
print("Variation in Box with error: " + math.sqrt(VarB1 / (M * N / 5)) + "\n")
print("Variation in Box Average of 5: " + math.sqrt(VarB5 / (M * N / 5)) + "\n")
print("Variation in Box Average of 10: " + math.sqrt(VarB10 / (M * N / 10)) + "\n")
print("Variation in Box Best 3 of 5: " + math.sqrt(VarB3 / (M * N / 5)) + "\n")
print("Variation in Box Median of 5: " + math.sqrt(VarBM / (M * N / 5)) + "\n")
print("Variation in Horizontal with error: " + math.sqrt(VarH1 / (M * N / 5)) + "\n")
print("Variation in Horizontal Average of 5: " + math.sqrt(VarH5 / (M * N / 5)) + "\n")
print("Variation in Horizontal Average of 10: " + math.sqrt(VarH10 / (M * N / 10)) + "\n")
print("Variation in Horizontal Best 3 of 5: " + math.sqrt(VarH3 / (M * N / 5)) + "\n")
print("Variation in Horizontal Median of 5: " + math.sqrt(VarHM / (M * N / 5)) + "\n")
print("\n\nWorst Case\n")
print("Worst Case Cylinder: " + WCC1 + ", " + WCC5 + ", " + WCC10 + ", " + WCC3 + ", " + WCCM + "\n")
print("Worst Case Box: " + WCB1 + ", " + WCB5 + ", " + WCB10 + ", " + WCB3 + ", " + WCBM + "\n")
print("Worst Case Horizontal: " + WCH1 + ", " + WCH5 + ", " + WCH10 + ", " + WCH3 + ", " + WCHM + "\n")
